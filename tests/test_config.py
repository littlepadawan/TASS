...
class TestConfig(unittest.TestCase):
    ...
    def test_config_path(self):
        ...
        self.assertEqual(config.config_file, os.path.abspath('tests/test_input/configuration.cfg'))
    ...
    def test_compiler_gfortran(self):
        ...
        config._validate_configuration()
        self.assertEqual(config.path_turbospectrum_compiled, os.path.abspath('tests/test_input/turbospectrum/exec-gf'))
    ...
    def test_compiler_intel(self):
        ...
        config._validate_configuration()
        self.assertEqual(config.path_turbospectrum_compiled, os.path.abspath('tests/test_input/turbospectrum/exec'))  
